...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void keyPressed(KeyEvent e) {
		...
		switch(e.getKeyCode()) {
			case KeyEvent.VK_UP:
				Location l = snake.getHeadLocation();
	...
	private void setFoodLocation() {
		...
		int a = rng.nextInt(HEIGHT-1) + 1;
		Location l = new Location(x, a);
		...
		foodLocation = l;
	    boolean b = snake.isLocationOnSnake(foodLocation);		
	    if(b== true) {
	    	setFoodLocation();
	    }
	...
	private void gameOver() {
		...
		if(a==0) {
			...
			snake.getHeadLocation().x = 5;
			snake.getHeadLocation().y = 5;
			setFoodLocation();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(snake.isHeadCollidingWithBody() || snake.isOutOfBounds() == true) {
			gameOver();
		}
